...
Recommended hyperparameters: \* Vocabulary size: `train_dataset.vocab_size` (Don't change) \* Embedding size: `128` \* Number of out channels: `64` \* Filter heights (i.e., n-gram sizes): `[2, 3, 4]` \* Stride: `1` \* Dropout: `0.5` \* Number of classes: `2` (Don't change) \* Pad token index: `train_dataset.word2idx[PAD]` (Don't change)
...
Recommended hyperparameters: \* Vocabulary size: `train_dataset.vocab_size` (Don't change) \* Embedding size: `128` \* Hidden size: `128` \* Number of layers: `2` \* Bidirectional: `True` \* Dropout: `0.5` \* Number of classes: `2` (Don't change) \* Pad token index: `train_dataset.word2idx[PAD]` (Don't change)
