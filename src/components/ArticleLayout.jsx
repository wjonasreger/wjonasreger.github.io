...
export function ArticleLayout({
  ...
  return (
    ...
    <NextSeo
      ...
      canonical={`https://wjonasreger.github.io${router.pathname}`}
      openGraph={{
        ...
        siteName: 'wjonasreger.github.io',
      }}
    />
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <article>
              <header className="flex flex-col">
                ...
                <h2 className="mt-4 text-xl font-bold tracking-tight text-zinc-800 dark:text-zinc-500 sm:text-2xl">
                  <i>{meta.noun}</i>
                </h2>
                ...
                >
                  ...
                  <span className="ml-3">{formatDate(meta.date, "mdy")}</span>
                </time>
              </header>
